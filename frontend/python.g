...
typedef struct PythonGlobals : Globals {
...
int python_user_size = sizeof(D_ParseNode_User);
int python_globals_size = sizeof(D_ParseNode_Globals);
...
file_input: (NEWLINE | stmt)* {
  ...
  $$.ast->scope_kind = Scope_SEQUENTIAL;
};
