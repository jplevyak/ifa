...
void prim_init(Primitives *p, IF1 *if1) {
  ...
  prim_index_object = new Prim(41, "index_object", "prim_index_object", -3, 0, 1, prim_index_object_arg_types, prim_index_object_ret_types, 0);
  ...
  prim_set_index_object = new Prim(42, "set_index_object", "prim_set_index_object", -4, 0, 1, prim_set_index_object_arg_types, prim_set_index_object_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_meta_apply = new Prim(43, "meta_apply", "prim_meta_apply", 3, 0, 1, prim_meta_apply_arg_types, prim_meta_apply_ret_types, 0);
  ...
  prim_destruct = new Prim(44, "destruct", "prim_destruct", 2, 0, 1, prim_destruct_arg_types, prim_destruct_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_set = new Prim(45, "make_set", "prim_set", -2, 0, 1, prim_set_arg_types, prim_set_ret_types, 0);
  ...
  prim_list = new Prim(46, "make_list", "prim_list", -2, 0, 1, prim_list_arg_types, prim_list_ret_types, 0);
  ...
  prim_merge_in = new Prim(49, "merge_in", "prim_merge_in", -3, 0, 1, prim_merge_in_arg_types, prim_merge_in_ret_types, 0);
  ...
  prim_type_assert = new Prim(50, "type_assert", "prim_type_assert", 3, 0, 1, prim_type_assert_arg_types, prim_type_assert_ret_types, 0);
  ...
  prim_sizeof_element = new Prim(53, "sizeof_element", "prim_sizeof_element", 2, 0, 1, prim_sizeof_element_arg_types, prim_sizeof_element_ret_types, 0);
