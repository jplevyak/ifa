...
void prim_init(Primitives *p, IF1 *if1) {
  ...
  prim_cast = new Prim(32, "(", "prim_cast", 3, 0, 1, prim_cast_arg_types, prim_cast_ret_types, 0);
  n = (char*)if1->strings.put((char*)"(");
  ...
  prim_strcat = new Prim(33, "::", "prim_strcat", 3, 1, 1, prim_strcat_arg_types, prim_strcat_ret_types, 0);
  n = (char*)if1->strings.put((char*)"::");
  ...
  prim_primitive = new Prim(34, "primitive", "prim_primitive", -2, 0, -1, prim_primitive_arg_types, prim_primitive_ret_types, 0);
  ...
  prim_reply = new Prim(35, "reply", "prim_reply", -3, 0, 1, prim_reply_arg_types, prim_reply_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_tuple = new Prim(36, "make_tuple", "prim_tuple", -2, 0, 1, prim_tuple_arg_types, prim_tuple_ret_types, 0);
  ...
  prim_continuation = new Prim(38, "make_continuation", "prim_continuation", -2, 0, 1, prim_continuation_arg_types, prim_continuation_ret_types, 0);
  ...
  prim_new = new Prim(39, "new", "prim_new", -2, 0, 1, prim_new_arg_types, prim_new_ret_types, 0);
  ...
  prim_clone = new Prim(40, "clone", "prim_clone", -2, 0, 1, prim_clone_arg_types, prim_clone_ret_types, 0);
  ...
  prim_clone_vector = new Prim(41, "clone_vector", "prim_clone_vector", -3, 0, 1, prim_clone_vector_arg_types, prim_clone_vector_ret_types, 0);
  ...
  prim_isinstance = new Prim(42, "isinstance", "prim_isinstance", -3, 0, 1, prim_isinstance_arg_types, prim_isinstance_ret_types, 0);
  ...
  prim_issubclass = new Prim(43, "issubclass", "prim_issubclass", -3, 0, 1, prim_issubclass_arg_types, prim_issubclass_ret_types, 0);
  ...
  prim_index_object = new Prim(44, "index_object", "prim_index_object", -3, 0, 1, prim_index_object_arg_types, prim_index_object_ret_types, 0);
  ...
  prim_set_index_object = new Prim(45, "set_index_object", "prim_set_index_object", -4, 0, 1, prim_set_index_object_arg_types, prim_set_index_object_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_meta_apply = new Prim(46, "meta_apply", "prim_meta_apply", 3, 0, 1, prim_meta_apply_arg_types, prim_meta_apply_ret_types, 0);
  ...
  prim_destruct = new Prim(47, "destruct", "prim_destruct", 2, 0, 1, prim_destruct_arg_types, prim_destruct_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_set = new Prim(48, "make_set", "prim_set", -2, 0, 1, prim_set_arg_types, prim_set_ret_types, 0);
  ...
  prim_list = new Prim(49, "make_list", "prim_list", -2, 0, 1, prim_list_arg_types, prim_list_ret_types, 0);
  ...
  prim_coerce = new Prim(50, "coerce", "prim_coerce", -3, 0, 1, prim_coerce_arg_types, prim_coerce_ret_types, 0);
  ...
  prim_merge = new Prim(51, "merge", "prim_merge", -3, 0, 1, prim_merge_arg_types, prim_merge_ret_types, 0);
  ...
  prim_merge_in = new Prim(52, "merge_in", "prim_merge_in", -3, 0, 1, prim_merge_in_arg_types, prim_merge_in_ret_types, 0);
  ...
  prim_type_assert = new Prim(53, "type_assert", "prim_type_assert", 3, 0, 1, prim_type_assert_arg_types, prim_type_assert_ret_types, 0);
  ...
  prim_len = new Prim(54, "len", "prim_len", 2, 0, 1, prim_len_arg_types, prim_len_ret_types, 0);
  ...
  prim_sizeof = new Prim(55, "sizeof", "prim_sizeof", 2, 0, 1, prim_sizeof_arg_types, prim_sizeof_ret_types, 0);
  ...
  prim_sizeof_element = new Prim(56, "sizeof_element", "prim_sizeof_element", 2, 0, 1, prim_sizeof_element_arg_types, prim_sizeof_element_ret_types, 0);
