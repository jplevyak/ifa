...
void prim_init(Primitives *p, IF1 *if1) {
  ...
  prim_clone_vector = new Prim(40, "clone_vector", "prim_clone_vector", -3, 0, 1, prim_clone_vector_arg_types, prim_clone_vector_ret_types, 0);
  ...
  prim_typeof_element = new Prim(55, "typeof_element", "prim_typeof_element", 2, 0, 1, prim_typeof_element_arg_types, prim_typeof_element_ret_types, 0);
