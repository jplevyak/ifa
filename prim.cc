...
Prim::Prim(int aindex, cchar *astring, cchar *aname, int anargs, int apos, int anrets, PrimType *aarg_types,
...
RegisteredPrim *prim_get(cchar *name) { return if1->primitives->registered_prims.get(name); }
